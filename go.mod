module terraform-provider-specifai
...
require (
	...
	github.com/hashicorp/terraform-provider-scaffolding-framework v0.0.0-20231116181645-61d9baa361fd
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/quicksight v1.52.0 // indirect
